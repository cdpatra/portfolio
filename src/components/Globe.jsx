...
import { World } from "./ui/globe"; // Ensure the path is correct based on your file structure
...
export function Globe() {
   ...
   return (
      <div className="flex flex-row items-center justify-center h-screen md:h-auto  relative w-full overflow-hidden">
         {/* dark:bg-gradient-to-b from-[rgb(25,31,36)]  via-black to-black bg-white */}
